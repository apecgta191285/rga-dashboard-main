...
let UsersController = class UsersController {
    ...
    update(tenantId, id, updateUserDto) {
...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)(dto_1.UserRole.ADMIN, dto_1.UserRole.MANAGER),
    (0, swagger_1.ApiOperation)({ summary: 'Get all users (Admin and Manager only)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('tenantId')),
    __param(1, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.QueryUsersDto]),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, roles_decorator_1.Roles)(dto_1.UserRole.ADMIN, dto_1.UserRole.MANAGER),
    (0, swagger_1.ApiOperation)({ summary: 'Get a single user by ID (Admin and Manager only)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)('tenantId')),
