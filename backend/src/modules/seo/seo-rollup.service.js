...
var SeoRollupService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.SeoRollupService = void 0;
const common_1 = require("@nestjs/common");
const client_1 = require("@prisma/client");
const prisma_service_1 = require("../../modules/prisma/prisma.service");
let SeoRollupService = SeoRollupService_1 = class SeoRollupService {
    constructor(prisma) {
        this.prisma = prisma;
        this.logger = new common_1.Logger(SeoRollupService_1.name);
    }
    dateKey(d) {
    ...
    async upsertDailySeoForTenant(tenantId, date) {
        ...
        if (existingDaily) {
            await this.prisma.webAnalyticsDaily.update({
                ...
                data: {
                    ...
                    engagementRate: new client_1.Prisma.Decimal(this.clamp(1 - bounceRate, 0, 1)),
                    bounceRate: new client_1.Prisma.Decimal(bounceRate),
                    avgSessionDuration: new client_1.Prisma.Decimal(avgSessionDuration),
                    isMockData: false,
                },
            });
        }
...
exports.SeoRollupService = SeoRollupService;
exports.SeoRollupService = SeoRollupService = SeoRollupService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], SeoRollupService);
//# sourceMappingURL=seo-rollup.service.js.map