...
exports.FacebookAdsAuthController = void 0;
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const config_1 = require("@nestjs/config");
const jwt_auth_guard_1 = require("../../auth/guards/jwt-auth.guard");
const facebook_ads_oauth_service_1 = require("./facebook-ads-oauth.service");
let FacebookAdsAuthController = class FacebookAdsAuthController {
    ...
    async handleCallback(code, state, res) {
        try {
            ...
            return res.redirect(`${this.frontendUrl}/data-sources?status=${result.status}&tempToken=${result.tempToken}&platform=facebook`);
        }
        catch (error) {
    ...
    async completeConnection(req, tempToken, accountId) {
        const tenantId = req.user.tenantId;
        if (!tempToken || !accountId) {
            throw new common_1.BadRequestException('Missing tempToken or accountId');
        }
...
exports.FacebookAdsAuthController = FacebookAdsAuthController;
__decorate([
    (0, common_1.Get)('url'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get Facebook Ads OAuth authorization URL' }),
    __param(0, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], FacebookAdsAuthController.prototype, "getAuthUrl", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], FacebookAdsAuthController.prototype, "handleCallback", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], FacebookAdsAuthController.prototype, "getTempAccounts", null);
__decorate([
    (0, common_1.Post)('complete'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Complete Facebook Ads connection by selecting an account' }),
    (0, swagger_1.ApiBody)({ schema: { type: 'object', properties: { tempToken: { type: 'string' }, accountId: { type: 'string' } } } }),
    __param(0, (0, common_1.Req)()),
    ...
    __metadata("design:returntype", Promise)
], FacebookAdsAuthController.prototype, "completeConnection", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], FacebookAdsAuthController.prototype, "getConnectedAccounts", null);
exports.FacebookAdsAuthController = FacebookAdsAuthController = __decorate([
    (0, swagger_1.ApiTags)('auth/facebook/ads'),
    (0, common_1.Controller)('auth/facebook/ads'),
    __metadata("design:paramtypes", [facebook_ads_oauth_service_1.FacebookAdsOAuthService,
        config_1.ConfigService])
], FacebookAdsAuthController);
//# sourceMappingURL=facebook-ads-auth.controller.js.map