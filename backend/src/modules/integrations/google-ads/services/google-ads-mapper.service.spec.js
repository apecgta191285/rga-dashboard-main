...
describe('GoogleAdsMapperService', () => {
    ...
    beforeEach(async () => {
        const module = await testing_1.Test.createTestingModule({
            providers: [google_ads_mapper_service_1.GoogleAdsMapperService],
        }).compile();
        service = module.get(google_ads_mapper_service_1.GoogleAdsMapperService);
    });
    ...
    describe('mapCampaignStatus', () => {
        ...
        it('should map string status correctly', () => {
            ...
            expect(service.mapCampaignStatus('UNKNOWN_STATUS')).toBe('PAUSED');
        });
    });
...
//# sourceMappingURL=google-ads-mapper.service.spec.js.map