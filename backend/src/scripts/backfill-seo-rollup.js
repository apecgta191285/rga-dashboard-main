...
async function upsertDailySeoForTenant(tenantId, date) {
    ...
    const dailyData = {
        ...
        engagementRate: new client_1.Prisma.Decimal(String(clamp(1 - bounceRate, 0, 1))),
        bounceRate: new client_1.Prisma.Decimal(String(bounceRate)),
        avgSessionDuration: new client_1.Prisma.Decimal(String(avgSessionDuration)),
        isMockData: false,
    };
    if (existingDaily) {
...
//# sourceMappingURL=backfill-seo-rollup.js.map