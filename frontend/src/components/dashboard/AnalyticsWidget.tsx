...
export function AnalyticsWidget() {
    // โ… Use global date range context
    ...
    // โ… FIX: Handle not connected case - show connect prompt instead of mock data
    // โ… FIX: Handle not connected case - show 0 values with "Not Connected" badge
    if (!data?.connected) {
        const emptyStats = [
            ...
            <div className="space-y-4">
                ...
                <Card className="border-orange-500/50 bg-orange-500/10">
                    <CardContent className="py-4">
                        <p className="text-sm text-orange-600">{data.message || 'เนเธกเนเธชเธฒเธกเธฒเธฃเธ–เธ”เธถเธเธเนเธญเธกเธนเธฅ GA4 เนเธ”เน'}</p>
                    </CardContent>
                </Card>
            </div>
        );
