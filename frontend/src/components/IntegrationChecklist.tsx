...
> = {
    'google-ads': {
        ...
        glowColor:
            'group-hover:shadow-red-100/50 dark:group-hover:shadow-red-900/30',
    },
    ...
    'facebook-ads': {
        ...
        glowColor:
            'group-hover:shadow-blue-100/50 dark:group-hover:shadow-blue-900/30',
    },
    ...
    'tiktok-ads': {
        ...
        glowColor:
            'group-hover:shadow-slate-200/50 dark:group-hover:shadow-slate-800/30',
    },
};
...
export function IntegrationChecklist() {
    ...
    const platforms = PLATFORMS.filter((p) =>
        CHECKLIST_PLATFORM_IDS.includes(p.id as any)
    );
                            ...
                            return (
                                ...
                                >
                                    <div className="flex items-start justify-between gap-4">
                                        ...
                                        <span
                                            className={`mt-1 h-3 w-3 rounded-full transition-transform group-hover:scale-125 ${dotClassName}`}
                                        />
                                    </div>
                                </button>
                            );
