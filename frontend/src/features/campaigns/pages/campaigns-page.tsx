...
import N8nChatWidget from '@/features/dashboard/components/ui/N8nChatWidget';
...
export function CampaignsPage() {
    ...
    return (
        <DashboardLayout>
            ...
            {/* Chatbot Widget (n8n webhook) */}
            <N8nChatWidget webhookUrl={import.meta.env.VITE_CHATBOT_WEBHOOK_URL} />
        </DashboardLayout>
    );
}
